...
export class BarChartComponent implements OnInit {
    ...
    tooltips: {
      callbacks: {
        label: function (tooltipItem) {
          return "" + Number(tooltipItem.yLabel) + "h";
        },
        labelColor: function (context) {
          return {
            borderColor: 'rgb(7, 77, 99)',
            backgroundColor: 'rgb(7, 77, 99)',
          };
        },
  ...
  public barChartLabels: Label[] = ['Mo', 'Tu', 'We', 'Th', 'Sa', 'Sun', 'Mo', 'Tu', 'We', 'Th', 'Sa', 'Sun'];
  ...
  public barChartColors: Color[] = [
    {
      ...
      hoverBackgroundColor: '#00BAD5'
    }
  ]
  public barChartData: ChartDataSets[] = [
    {
      data: [65, 59, 80, 81, 56, 55, 88, 65, 59, 80, 81, 56, 55, 40], label: 'Series A',
    ...
    Chart['elements'].Rectangle.prototype.draw = function() {
      ...
      for (var i = 1; i < 4; i++) {
        ...
        if (height < 0) {
          ...
          ctx.lineTo(x_bl, y_bl - radius-100);
